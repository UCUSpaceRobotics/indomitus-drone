...
def main():
    ...
    # ------------------------------------------------------------------
    # 8. Create the TestFlightController (state machine)
    # ------------------------------------------------------------------
    from tests.TestFlightController import TestFlightController, FlightState

    mission = TestFlightController(
    ...
    print("[MAIN] TestFlightController created — state machine ready.")
